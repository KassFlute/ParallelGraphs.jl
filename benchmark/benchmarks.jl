...
CLASSES = ["30k", "300k", "3M", "twitch", "wikipedia", "LiveJournal"] # classes of graphs for outputs
...
for i in eachindex(SIZE)
    ...
    #addgraphtolist(i, dorogovtsev_mendes(v), "dorogovtsev_mendes", 1) addgraphtolist(i, barabasi_albert(v, 2), "barabasi_albert - 2", 1)
...
#push!(
#    imported_graphs,
#    loadgraph("benchmark/data/wikipedia.txt", "wikipedia", EdgeListFormat()),
#)
#push!(names["Imported"], "wikipedia.txt")
#push!(i_first_vertex, 1)
#
#push!(
#    imported_graphs,
#    loadgraph("benchmark/data/LiveJournal.txt", "LiveJournal", EdgeListFormat()),
#)
#push!(names["Imported"], "LiveJournal.txt")
#push!(i_first_vertex, 1)
